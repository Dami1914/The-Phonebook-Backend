  ...
  number: {
    ...
    validate: {
      validator: (value) => {
        ...
        } else if (Number.isNaN(contact.join(''))) {
...
function capitalizeFirstChar(str) {
  ...
  return str
    .split(' ')
    .map((ele) => ele.charAt(0).toUpperCase() + ele.slice(1) /* join(" ") turns content of an array to single a string having also considering the space in between them (" ") */).join(' ');
}
